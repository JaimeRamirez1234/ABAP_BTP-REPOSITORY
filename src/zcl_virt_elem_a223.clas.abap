CLASS zcl_virt_elem_a223 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virt_elem_a223 IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~get_calculation_info.

        IF iv_entity = 'Z_C_TRAVEL_LOG_A23'.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
        ...
        DATA lt_original_data TYPE STANDARD TABLE OF z_c_travel_log_a23 WITH DEFAULT KEY.
